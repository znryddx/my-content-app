...
const PER_TYPE = 6;                 // 每类型目标条数 -> 每类 24 条
...
function buildCatPrompt(cat, date) {
  return [
    ...
    `{"items":[{"type":"short","text":"文案"},...]}`,
    ``,
    `要求：`,
    `1. items 共 ${TARGET} 条：type 取值 short/long/vip/culture 各 ${PER_TYPE} 条。`,
    `2. 类型口径：short=美学金句(1~3句，30字内最佳); long=材质/工艺/场景叙事(120~220字); vip=高净值客群(稀缺/圈层/身份/收藏/传家/送礼); culture=文化营销(文化叙事+成交引导:私洽/限量/定制/到店/排期)。`,
